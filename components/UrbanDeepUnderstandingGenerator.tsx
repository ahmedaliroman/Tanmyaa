...
const UrbanDeepUnderstandingGenerator: React.FC<GeneratorProps> = ({ onUpgrade }) => {
    ...
    const renderResult = (result: UrbanDeepUnderstanding) => (
        <div className="space-y-12 animate-fade-in font-sans">
            ...
            >
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-24 border-b border-gray-200 pb-12 relative z-10">
                    <div className="flex items-center space-x-10 mb-8 md:mb-0">
                        ...
                        <div>
                            <h1 className="text-5xl font-extrabold text-gray-900 tracking-tighter uppercase leading-none mb-3 font-sans">Deep Understanding</h1>
                ...
                <div className="max-w-6xl mx-auto mb-32 relative z-10">
                    <div className="flex items-center space-x-6 mb-12">
                        ...
                        <span className="text-[12px] font-bold text-gray-400 uppercase tracking-[0.5em] font-sans">Principal Strategist Opening</span>
                    </div>
                    
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
                        <div className="lg:col-span-8">
                            <h2 className="text-6xl md:text-8xl font-black text-gray-900 mb-12 tracking-tighter leading-[0.85] uppercase font-sans">
                                {result.topic}
                            </h2>
                        ...
                        <div className="lg:col-span-4 bg-white p-10 border border-gray-200 shadow-xl rounded-none relative">
                            ...
                            <div className="flex items-center space-x-3 mb-8 font-mono">
                    ...
                    {result.stickyNotes.map((note, idx) => (
                        ...
                        >
                            ...
                            <div className="flex flex-col h-full font-sans">
                                ...
                                <h3 className="text-3xl font-extrabold mb-8 leading-none text-gray-900 uppercase tracking-tighter group-hover:text-blue-600 transition-colors duration-300 font-sans">
                                    {note.title}
                                </h3>
                                ...
                                <div className="flex flex-wrap gap-3 mt-auto font-mono">
                                    {note.tags.map((tag, i) => (
                ...
                <div className="max-w-6xl mx-auto bg-white border border-gray-100 p-10 md:p-20 shadow-2xl relative z-10 mb-32 overflow-hidden">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center gap-12 mb-20 relative z-10">
                        <div className="w-28 h-28 bg-gray-900 flex items-center justify-center text-white font-extrabold text-6xl shadow-2xl shrink-0 font-sans">?</div>
                        <div>
                            <h3 className="text-5xl font-black text-gray-900 uppercase tracking-tighter leading-none mb-3 font-sans">Strategic Inquiry</h3>
                            <p className="text-blue-600 font-bold text-[12px] uppercase tracking-[0.5em] font-sans">Field Challenge for Decision Makers</p>
                        </div>
                    </div>
                    
                    <p className="text-4xl md:text-5xl text-gray-900 mb-20 font-black leading-[1.05] tracking-tighter uppercase relative z-10 font-sans">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-20 relative z-10">
                        {result.lessonInteraction.choices.map((choice) => (
                            <button
                                ...
                                className={`p-10 rounded-none text-xl font-bold transition-all border-2 text-left flex flex-col justify-between h-full group font-sans ${
                            ...
                            >
                                <span className={`text-[10px] uppercase tracking-[0.3em] mb-8 font-mono ${selectedChoice === choice ? 'text-gray-400' : 'text-gray-300 group-hover:text-gray-500'}`}>Selection_Node</span>
                                {choice}
                            </button>
                        ))}
                    </div>
                    ...
                    {selectedChoice && (
                        <div className="animate-slide-up bg-blue-600 p-12 relative overflow-hidden shadow-2xl">
                            ...
                            <p className="text-[11px] font-bold text-white/70 uppercase tracking-[0.5em] mb-8 font-sans">Strategic Analysis Feedback</p>
                            <p className="text-white font-serif italic leading-tight text-4xl relative z-10 font-medium font-serif">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-12 border-t border-gray-200 pt-16 relative z-10 font-mono">
                ...
                <div className="mt-24 text-center max-w-4xl mx-auto relative z-10">
                    <p className="text-3xl text-gray-400 font-serif italic mb-8 leading-relaxed font-medium font-serif">
            ...
            <div className="mt-16 bg-white border-2 border-gray-900 rounded-[3rem] p-8 md:p-12 shadow-2xl relative overflow-hidden font-sans">
                ...
                <div className="max-w-2xl mx-auto text-center mb-10 relative z-10">
                    <h3 className="text-3xl font-black text-gray-900 mb-4 tracking-tighter uppercase font-sans">Consult the Professor</h3>
                ...
                <div className="relative max-w-3xl mx-auto z-10">
                    <textarea
                        ...
                        rows={3}
                        className="w-full bg-gray-50 border-2 border-gray-200 rounded-[2rem] py-6 px-8 text-gray-900 placeholder-gray-400 focus:outline-none focus:border-blue-600 transition duration-300 resize-none pr-32 text-lg font-medium font-sans"
                        disabled={isRefining}
                    />
                    <button
                        onClick={handleRefine}
                        disabled={isRefining || !refinementRequest.trim()}
                        className="absolute right-4 bottom-4 bg-gray-900 hover:bg-blue-600 text-white font-black py-3 px-8 rounded-2xl transition-all disabled:bg-gray-200 disabled:text-gray-400 shadow-xl font-sans"
                    >
                        {isRefining ? 'CONSULTING...' : 'CONSULT'}
                    </button>
                </div>
                <div className="flex items-center justify-center space-x-3 mt-6">
                    <span className="text-[10px] text-gray-400 uppercase tracking-[0.2em] font-mono">Consultation Fee: 5 Credits</span>
                </div>
            </div>
        </div>
    );
