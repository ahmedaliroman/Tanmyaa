    ...
    const renderResult = (result: UrbanDeepUnderstanding) => (
        <div className="space-y-12 animate-fade-in">
            ...
            <div className="text-center max-w-3xl mx-auto mb-12">
                <h2 className="text-4xl md:text-5xl font-black text-white tracking-tighter mb-4">{result.topic}</h2>
            ...
            <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    {result.dataInsights.map((insight, idx) => renderChart(insight, idx))}
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div className="bg-blue-600/5 border border-blue-600/20 rounded-3xl p-8">
                    ...
                    {result.interactiveElements.map((el, idx) => (
