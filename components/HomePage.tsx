...
const services = [
  { id: 'masterplan-designer', title: 'Master Plan Designer', description: 'Generate a complete, consistent, and professional masterplan design system with advanced spatial DNA.', icon: <IconMasterplan /> },
